<%-- 
    Document   : dashboard
    Created on : Feb 26, 2026, 9:49:43 PM
    Author     : Haruda
--%>
...
<div class="container">
    <div class="hero">
        ...
        <p>Manage staff access, monitor operations, and maintain secure role-based control for Ocean View Resort.</p>
    ...
    <div class="grid">
        <div class="card">
            ...
            <p>Create accounts with controlled permissions. Public registration remains CUSTOMER only to prevent privilege escalation.</p>
            <div class="action">
        ...
        <div class="card">
            <h3>Staff Console</h3>
            <p>Access operational tools for reservation verification, booking management, billing support, and front-desk tasks.</p>
            <div class="action">
                <a class="btn" href="<%=request.getContextPath()%>/staff/dashboard.jsp">Open Staff Console</a>
        ...
        <div class="card">
            <h3>System Help</h3>
            <p>View help guidelines for staff onboarding, operational procedures, and secure usage of the system.</p>
            <div class="action">
