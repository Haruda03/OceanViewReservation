<%-- 
    ...
    Created on : Feb 28, 2026, 11:00:24 AM
    Author     : Haruda
--%>
...
<head>
    ...
    <style>
        ...
        .smallbtn{ padding:8px 10px; border-radius:10px; background:#00c3ff; color:#fff; text-decoration:none; font-weight:800; }
...
<div class="container">
    ...
    <div class="hero">
        ...
        <p>
            These are reservation requests sent for staff approval. Requests expire if staff does not approve within the allowed time period.
        </p>
    ...
    <div class="card" style="margin-top:16px;">
        ...
        <div class="actions" style="margin-top:10px;">
            <a class="btn" href="<%=request.getContextPath()%>/customer/book">New Request</a>
        ...
        %>
            <p style="margin-top:14px;color:#555;">
                No reservation requests found yet. Use <b>Request Reservation</b> on the booking page.
            </p>
        <%
            } else {
        %>
        ...
        <table>
            ...
            %>
                <tr>
                    ...
                    <td>
                        <%
                            if ("PENDING".equals(st) && r.getExpiresAt() != null) {
                        %>
                            <%= r.getExpiresAt() %>
                        <%
                            } else {
