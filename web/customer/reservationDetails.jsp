<%-- Document : reservationDetails Created on : Feb 28, 2026, 11:38:58 AM Author : Haruda --%>
        ...
        <%@page import="model.ReservationDetail" %>
            <%@page import="java.time.temporal.ChronoUnit" %>
                ...
                <% String fullName=(String) session.getAttribute("fullName"); String role=(String)
                    session.getAttribute("role"); String err=(String) request.getAttribute("error"); ReservationDetail
                    d=(ReservationDetail) request.getAttribute("detail"); long nights=0; if (d !=null)
                    nights=ChronoUnit.DAYS.between(d.getCheckIn(), d.getCheckOut()); %>
                    ...
                    <body>
                        ...
                        <div class="container">
                            ...
                            <div class="hero">
                                ...
                                <p>View your booking request, approval status, and stay information. Use your
                                    reservation number when contacting the resort.</p>
                                    ...
                                    <% } %>
                                        ...
                                        <% if (d !=null) { %>
                                            ...
                                            <div class="kv">
                                                ...
                                                <div class="v"><span class="status <%= d.getStatus() %>">
                                                        <%= d.getStatus() %>
                                                    </span></div>

                                                <div class="k">Guest</div>
                                                <div class="v">
                                                    <%= d.getFullName() %> (<%= d.getEmail() %>)
                                                </div>

                                                <div class="k">Room</div>
                                                <div class="v">
                                                    <%= d.getRoomType() %> • LKR <%= d.getRate() %> / night
                                                </div>
                                                ...
                                                <div class="v">
                                                    <%= (d.getExpiresAt()==null ? "-" : d.getExpiresAt()) %>
                                                </div>

                                                <div class="k">Approved At</div>
                                                <div class="v">
                                                    <%= (d.getApprovedAt()==null ? "-" : d.getApprovedAt()) %>
                                                </div>

                                                <div class="k">Approved By</div>
                                                <div class="v">
                                                    <%= (d.getApprovedByName()==null ? "-" : d.getApprovedByName()) %>
                                                </div>

                                                <div class="k">Decision Note</div>
                                                <div class="v">
                                                    <%= (d.getDecisionNote()==null ? "-" : d.getDecisionNote()) %>
                                                </div>
                                            </div>
                                            ...
                                            <%-- Status guidance message --%>
                                                <% if ("PENDING".equals(d.getStatus())) { %>
                                                    <div class="note warn">
                                                        Your reservation is <b>PENDING</b>. Staff will approve within
                                                        the allowed time period.
                                                        If not approved before expiry, it becomes <b>EXPIRED</b>.
                                                    </div>
                                                    <% } else if ("REJECTED".equals(d.getStatus())) { %>
                                                        <div class="note bad">
                                                            Your request was <b>REJECTED</b>. If you need support,
                                                            please contact the resort or submit a new request.
                                                        </div>
                                                        <% } else if ("EXPIRED".equals(d.getStatus())) { %>
                                                            <div class="note gray">
                                                                Your request has <b>EXPIRED</b> because it was not
                                                                approved within the allowed time.
                                                                Please submit a new reservation request.
                                                            </div>
                                                            <% } else if ("CONFIRMED".equals(d.getStatus())) { %>
                                                                <div class="note">
                                                                    Your reservation is <b>CONFIRMED</b>. You can now
                                                                    generate your bill and receipt.
                                                                </div>
                                                                <% } %>

                                                                    <div class="actions" style="margin-top:14px;">
                                                                        <a class="btn-back"
                                                                            href="<%=request.getContextPath()%>/customer/my-reservations">
                                                                        ...
                                                                        <% if ("CONFIRMED".equals(d.getStatus())
                                                                            ...
                                                                            <a class="btn"
                                                                                href="<%=request.getContextPath()%>/customer/bill?no=<%= d.getReservationNo() %>">
                                                                                Go to Bill
                                                                            </a>
                                                                            <% } %>
                                                                    </div>
