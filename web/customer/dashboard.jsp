<%-- Document : dashboard Created on : Feb 25, 2026, 10:09:25 PM Author : Haruda --%>
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        <% String fullName=(String) session.getAttribute("fullName"); String role=(String) session.getAttribute("role");
            if (fullName==null || fullName.trim().isEmpty()) { fullName="Guest" ; } if (role==null ||
                ...
                <div class="full-hero">
                    <div class="hero-inner">
                        ...
                        <div style="text-align:center; margin-bottom:30px;">
                            ...
                            <p>
                                Book instantly or request a reservation for staff approval. Track your bookings and
                        ...
                        <div class="grid">
                            ...
                            <div class="glass-card">
                                ...
                                <div class="action">
                                    <a class="btn"
                                        href="<%=request.getContextPath()%>/customer/my-reservations">View</a>
                                </div>
                            </div>
