<%-- Document : myBookings Created on : Mar 2, 2026, 9:13:49 AM Author : Haruda --%>
                        ...
                        List<ReservationView> bookings = (List<ReservationView>) request.getAttribute("bookings");
                            ...
                            <body>
                                ...
                                <div class="container">
                                    ...
                                    <div class="hero">
                                        <h1>My Bookings</h1>
                                        <p>These bookings were confirmed instantly when you selected <b>Book Now</b>.
                                        </p>
                                            ...
                                            <% } %>
                                                ...
                                                <div class="actions" style="margin-top:10px;">
                                                    <a class="btn"
                                                        ...
                                                        Booking</a>
                                                    <a class="btnlink"
                                                        href="<%=request.getContextPath()%>/customer/dashboard.jsp">Back</a>
                                                </div>

                                                <% if (bookings==null || bookings.isEmpty()) { %>
                                                    <p style="margin-top:14px;color:#555;">No direct bookings found yet.
                                                    </p>
                                                    <% } else { %>
                                                        ...
                                                        <table>
                                                            ...
                                                            <tbody>
                                                                <% for (ReservationView r : bookings) { long
                                                                            ...
                                                                            <%-- Bill allowed only for CONFIRMED --%>
                                                                                <% if
                                                                                    ...
                                                                                    <% } %>
                                                                                        ...
                                                                                        <%-- Invoice available for any
                                                                                            status --%>
                                                                                            <a class="smallbtn"
                                                                                                style="background:#28a745; color:#fff;"
                                                                                                href="<%=request.getContextPath()%>/customer/invoice?no=<%= r.getReservationNo() %>">
                                                                                                Invoice
                                                                                            </a>
                                                                        </td>
                                                                    </tr>
