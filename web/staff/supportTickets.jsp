<%-- 
    ...
    Created on : Mar 2, 2026, 10:36:40 AM
    Author     : Haruda
--%>
...
<head>
    ...
    <style>
        ...
        .btn-sm{
            ...
            background:#00c3ff; color:#fff; font-weight:900; cursor:pointer;
        }
...
<div class="container">
    ...
    <div class="hero">
        ...
        <p>View customer support requests and update ticket status for efficient service management.</p>
        ...
        <table>
            ...
            <% for (SupportTicket t : tickets) { %>
                <tr>
                    ...
                    <td>
    <b><%= t.getCustomerName() %></b>
    <div class="muted"><%= t.getCustomerEmail() %></div>
    <div class="muted">User ID: <%= t.getUserId() %></div>
</td>
                    <td>
                        <b><%= t.getSubject() %></b>
                    ...
                    <td>
                        <form method="post" action="<%=request.getContextPath()%>/staff/support">
                            <div class="row-actions">
                                <input type="hidden" name="ticketId" value="<%= t.getTicketId() %>">
                                <select name="status" required>
                                    <option value="OPEN" <%= "OPEN".equals(t.getStatus()) ? "selected" : "" %>>OPEN</option>
                                    <option value="IN_PROGRESS" <%= "IN_PROGRESS".equals(t.getStatus()) ? "selected" : "" %>>IN_PROGRESS</option>
                                    <option value="CLOSED" <%= "CLOSED".equals(t.getStatus()) ? "selected" : "" %>>CLOSED</option>
                                </select>
