<%-- Document : reports Created on : Feb 25, 2026, 10:12:30 PM Author : Haruda --%>
        ...
        <%@page import="java.util.*" %>
            <%@page import="java.time.LocalDate" %>
                ...
                <% String fullName=(String) session.getAttribute("fullName"); String role=(String)
                    ...
                    from=(LocalDate) request.getAttribute("from"); LocalDate toIncl=(LocalDate)
                    request.getAttribute("toInclusive"); Map<String,Integer> statusCounts = (Map<String,Integer>)
                        request.getAttribute("statusCounts");
                        ...
                        List<Map<String,Object>> topRooms = (List<Map<String,Object>>) request.getAttribute("topRooms");
                                List<Map<String,Object>> dailyRevenue = (List<Map<String,Object>>)
                                        request.getAttribute("dailyRevenue");
                                        ...
                                        if(statusCounts == null) statusCounts = new HashMap<>();
                                            ...
                                            <head>
                                                ...
                                                <link rel="stylesheet"
                                                    href="<%=request.getContextPath()%>/css/ocean-app.css">
                                                <style>
                                                    .grid2 {
                                                        display: grid;
                                            ...
                                            <body>
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="hero">
                                                        ...
                                                        <p>Operational insights and revenue analysis for resort
                                                            management.</p>
                                                    ...
                                                    <div class="actions" style="margin-top:14px;">
                                                        ...
                                                        <a class="btn"
                                                            href="<%=request.getContextPath()%>/staff/reports">Refresh</a>
                                                    </div>
                                                    ...
                                                    <% if(err !=null){ %>
                                                        ...
                                                        <% } %>
                                                            ...
                                                            <div class="card" style="margin-top:16px;">
                                                                <h3>Date Range</h3>
                                                                <form method="get"
                                                                    action="<%=request.getContextPath()%>/staff/reports"
                                                                    ...
                                                                    <input type="date" name="to"
                                                                        value="<%= toIncl != null ? toIncl.toString() : "" %>">
                                                            ...
                                                            <div class="card" style="margin-top:16px;">
                                                                ...
                                                                <div class="grid2" style="margin-top:10px;">
                                                                    ...
                                                                    <div class="stat">
                                                                        <h4>Expired</h4>
                                                                        <div class="num">
                                                                            <%= statusCounts.getOrDefault("expired",0)
                                                                                %>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="card" style="margin-top:16px;">
                                                                ...
                                                                <p class="muted">
                                                                    Revenue is calculated as: nights × room rate for
                                                                    CONFIRMED/COMPLETED stays (based on check-in date).
                                                                </p>
                                                                <div
                                                                    style="font-size:28px;font-weight:900;margin-top:10px;">
                                                                    LKR <%= revenue %>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card" style="margin-top:16px;">
                                                                ...
                                                                <% if(topRooms==null || topRooms.isEmpty()){ %>
                                                                    <p class="muted">No data found for the selected
                                                                        range.</p>
                                                                    <% } else { %>
                                                            ...
                                                            <div class="card" style="margin-top:16px;">
                                                                ...
                                                                <p class="muted">Use this table to create a chart in
                                                                    your report (optional upgrade).</p>
                                                            ...
                                                            <div class="footer">© 2026 Ocean View Resort • Reports &
                                                                Analytics</div>
                                                </div>
