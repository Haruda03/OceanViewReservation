<%-- 
    Document   : rooms
    Created on : Mar 2, 2026, 12:49:51 PM
    Author     : Haruda
--%>
...
<head>
    ...
    <style>
        ...
        input, select{ padding:8px 10px; border-radius:10px; border:1px solid #cfd9e6; }
        .row-actions{ display:flex; gap:8px; flex-wrap:wrap; align-items:center; }
        .btn-sm{ padding:8px 12px; border-radius:10px; border:none; background:#00c3ff; color:#fff; font-weight:900; cursor:pointer; }
        .btn-danger{ padding:8px 12px; border-radius:10px; border:none; background:#e64b4b; color:#fff; font-weight:900; cursor:pointer; }
...
<div class="container">
    ...
    <div class="hero">
        ...
        <p>Manage room rates and availability. Add new rooms or deactivate rooms when needed.</p>
    ...
    <div class="split" style="margin-top:16px;">
        ...
        <div class="card">
            <h3>Add New Room</h3>
            <form method="post" action="<%=request.getContextPath()%>/staff/rooms">
                <input type="hidden" name="action" value="add">

                <div style="margin-top:10px;">
                    <label><b>Room Type</b></label><br/>
                    <input type="text" name="roomType" placeholder="e.g., Deluxe Ocean View" required>
                </div>

                <div style="margin-top:10px;">
                    <label><b>Rate (LKR)</b></label><br/>
                    <input type="number" step="0.01" name="rate" placeholder="e.g., 15000" required>
                </div>

                <div style="margin-top:10px;">
                    <label><b>Max Guests</b></label><br/>
                    <input type="number" name="maxGuests" min="1" max="20" value="2" required>
                </div>
                ...
                <p class="muted" style="margin-top:10px;">
                    Tip: Use INACTIVE to temporarily hide a room from customer booking.
                </p>
            </form>
        </div>
        ...
        <div class="card">
            ...
            <% if (rooms == null || rooms.isEmpty()) { %>
                <p class="muted" style="margin-top:10px;">No rooms found.</p>
            <% } else { %>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="<%=request.getContextPath()%>/staff/rooms">
                                ...
                                <input type="number" step="0.01" name="rate" value="<%= r.getRate() %>" required>
                        </td>
                        ...
                        <td>
                                <select name="status">
                                    ...
                                    <option value="INACTIVE" <%= "INACTIVE".equals(r.getStatus()) ? "selected" : "" %>>INACTIVE</option>
                                </select>
                        </td>
