<%-- Document : pendingRequests Created on : Mar 1, 2026, 8:10:09 PM Author : Haruda --%>
                            ...
                            <body>
                                ...
                                <div class="container">
                                    ...
                                    <div class="hero">
                                        ...
                                        <p>Review reservation requests submitted by customers. Approve or reject before
                                            expiry to maintain availability and booking accuracy.</p>
                                        ...
                                        <% if (err !=null) { %>
                                            ...
                                            <% } %>
                                                ...
                                                <div class="actions" style="margin-top:10px;">
                                                    <a class="btn-back"
                                                        href="<%=request.getContextPath()%>/staff/dashboard.jsp">
                                                    ...
                                                    <a class="btn"
                                                        href="<%=request.getContextPath()%>/staff/reservations">Refresh</a>
                                                </div>

                                                <% if (list==null || list.isEmpty()) { %>
                                                    <p style="margin-top:14px;color:#555;">No active pending requests
                                                        right now.</p>
                                                    <% } else { %>
                                                        ...
                                                        <table>
                                                            ...
                                                            <tbody>
                                                                <% for (ReservationView r : list) { long
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><span class="chip pending">PENDING</span>
                                                                        </td>
                                                                        <td>
                                                                            <%= r.getExpiresAt() %>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <div class="row-actions">
                                                                                <!-- APPROVE -->
                                                                                <form method="post"
                                                                                    action="<%=request.getContextPath()%>/staff/reservations">
